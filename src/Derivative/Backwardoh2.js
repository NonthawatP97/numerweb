...
class Backwardoh2 extends Component{
    constructor(){
        super();
        this.state={
            fx: "",
    ...
    render(){
        return(
            <Layout style={{background: '#C9E2EF',padding: 24,minHeight: 1000, marginLeft: 0}}>
                <div>
        <h2 style={{ color: "black", fontWeight: "bold" }}>Backward O(h^2)</h2>
                    <div onChange={this.handleChange}>
                        ...
                        <br /><br />
                        <Button onClick={() => this.bwoh2(parseFloat(this.state.x),parseFloat(this.state.h),parseFloat(this.state.d))
                            }
                    ...
                    {this.state.showOutput &&
                        <div style={{background: '#FFE7E2',width: 400}}>
                            ...
                            <h2>FWO(h): F<sup>{this.state.d}</sup>(x)={this.state.ans}</h2>
