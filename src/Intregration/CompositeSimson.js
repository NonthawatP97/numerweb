    ...
    render(){
        return(
           <Layout style={{background: '#C9E2EF',padding: 24,minHeight: 1000, marginLeft: 0}}>
               <div>
               <h2 style={{ color: "black", fontWeight: "bold" }}>Composite Simpson's </h2>
                    ...
                    <Button onClick={() => this.compositesimp(parseFloat(this.state.a),parseFloat(this.state.b),parseFloat(this.state.n))
                            }
                    ...
                    {this.state.showOutput &&
                        <div style={{background: '#FFE7E2',width: 400}}>
                            ...
                            <h2>Composite Simpson's: {this.state.ans}</h2>
